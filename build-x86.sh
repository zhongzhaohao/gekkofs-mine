...
cd build
cmake -DGKFS_MAX_OPEN_FDS=204800 -DGKFS_ENABLE_MEMCACHED:BOOL=OFF -DGKFS_ENABLE_REDIS:BOOL=OFF -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH=${GKFS_HOME}/${DEPS_PATH} -DCMAKE_INSTALL_PREFIX=${GKFS_HOME}/install ..
